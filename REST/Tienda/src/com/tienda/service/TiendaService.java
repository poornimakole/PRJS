...
public class TiendaService {
	...
	public Set<Product>getAllProductsForOrder(String username,String number) throws OrderNotFoundException
	{
		return new DataStore().getAllProductsForOrder(username, number);
	}
